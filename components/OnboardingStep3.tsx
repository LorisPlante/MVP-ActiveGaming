...
const OnboardingStep3: React.FC<OnboardingStepProps> = ({ nextStep, previousStep }) => {
  const [currentPage, setCurrentPage] = useState(2); // Assurez-vous que 2 est la page actuelle
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url("/step3.jpeg")',
      ...
      <Image
        ...
        <h1 className="text-3xl font-bold leading-10 tracking-wide font-space-grotesk">
          DEVENEZ UNE LÉGENDE DU JEUX
        </h1>
       
        <p className="text-sm leading-6 font-ubuntu mt-2">
          Plus vous faites de l’activité physique.
        </p>
        <p className="text-sm leading-6 font-ubuntu">
          Plus vous serez récompensés, en débloquant des items spéciaux et des personnages uniques.
        </p>
      </div>
